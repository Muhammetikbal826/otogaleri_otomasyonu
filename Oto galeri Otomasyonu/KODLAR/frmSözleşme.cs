...
namespace Otogaleri1
{
    public partial class frmSözleşme : Form
    {
        ...
        {
            string sorgu2 = "insert into sözleşme(tc,adsoyad,telefon,ehliyetno,e_tarih,e_yer,plaka,marka,seri,yıl,renk,kirasekli,ücret,gun,tutar,ctarih,dtarih) values(@tc,@adsoyad,@telefon,@ehliyetno,@e_tarih,@e_yer,@plaka,@marka,@seri,@yıl,@renk,@kirasekli,@ücret,@gun,@tutar,@ctarih,@dtarih)";
        SqlCommand komut2 = new SqlCommand();
            ...
            komut2.Parameters.AddWithValue("@yıl", txtYıl.Text);
            komut2.Parameters.AddWithValue("@renk", txtRenk.Text);
            komut2.Parameters.AddWithValue("@kirasekli", comboKiraŞekli.Text);
            komut2.Parameters.AddWithValue("@ücret", int.Parse(txtKiraÜcreti.Text));
            ...
            string sorgu3 = "uptade araç set durumu= 'DOLU' where plaka'"+comboAraçlar.Text +"'";
        ...
        {
            string sorgu2 = "update sözleşme set tc=@tc,adsoyad=@adsoyad,telefon=@telefon,ehliyetno=@ehliyetno,e_tarih=@e_tarih,e_yer=@e_yer,marka=@marka,seri=@seri,yıl=@yıl,renk=@renk,kirasekli=@kirasekli,ücret=@ücret,gun=@gun,tutar=@tutar,ctarih=@ctarih,dtarih=@dtarih,where plaka=@plaka";
            SqlCommand komut2 = new SqlCommand();
            komut2.Parameters.AddWithValue("@tc", txtTc.Text);
            komut2.Parameters.AddWithValue("@adsoyad", txtAdSoyad.Text);
            komut2.Parameters.AddWithValue("@telefon", txtTelefon.Text);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int ucret = int.Parse(satır.Cells["ücret"].Value.ToString());
        ...
        private void btnAraçTeslim_Click(object sender, EventArgs e)
        {
            if (int.Parse(txtEkstra.Text)>=0 || int.Parse(txtEkstra.Text) < 0)
            {
                ...
                string sorgu3 = "insert into satış(tc,adsoyad,plaka,marka,seri,yıl,renk,gun,tutar,tarih1,tarih2,fiyat) values(@tc,@adsoyad,@plaka,@marka,@seri,@yıl,@renk,@gun,@tutar,@tarih1,@tarih2,@fiyat)";
                SqlCommand komut2 = new SqlCommand();
                ...
                komut2.Parameters.AddWithValue("@yıl", satır.Cells["yıl"].Value.ToString());
